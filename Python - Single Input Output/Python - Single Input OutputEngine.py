...
class HelloWorld(Plugin):
    ...
    def __init__(self, provider: ProviderBase):
        ...
        self.output_anchor = self.provider.get_output_anchor(self.output_anchor_name)
    ...
    def on_input_connection_opened(self, input_connection: InputConnectionBase) -> None:
        """Initialize the Input Connection and handle metadata."""
    ...
    def on_complete(self) -> None:
        """Handle any final steps when the plugin is complete."""
